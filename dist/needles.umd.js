(function (global, factory) {
  ...
  class Controller {
    constructor(options) {
      ...
      this.context = this.source.context;
      this.offline =
        options.offline || this.context instanceof OfflineAudioContext;
    ...
    _throwInvalidStateErrorFor(action) {
      throw new InvalidStateError(
        `Failed to execute '${action}' on 'Needles': The Needles's state is '${this.state}'.`
      );
    }
  }
